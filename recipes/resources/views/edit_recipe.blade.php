  ...
  <div class="container shadow p-4">
    ...
    <form action="{{ route('recipes.edit', $recipe->id) }}" method="POST">
            ...
            <div class="flex-column">
              ...
              <div class="row justify-content-center m-4"><input type="text" id="title" name="title" value="{{ $recipe->title }}"></div>
              <h2 class="row justify-content-center mt-1">Instructions:</h2>
              <div class="row justify-content-center m-4"><textarea name="description" id="description" cols="30" rows="10">{{ $recipe->description }}</textarea></div>           
